...
# 📖 Bookstore App<a name="about-project"></a>
 ...
 I developed a Bookstore App using React,Redux  and APIs. This project aims to create a simple and intuitive interface that allows users to perform math task in a style manner.👌 Builds the app for production to the build folder.
...
- Clone this repo here:
 ...
 git clone https://github.com/techmoves/bookstores.git
...
Feel free to check the [issues page](https://github.com/techmoves/bookstores/issues)
